...
DEMO_PROFILES = {
    ...
    "night-tilter": {
        ...
        "sessions": [
            _session("2026-05-04", "afternoon", 3, 0.88, 0, 2, 0, 0, [], 5.2, 7.8, ["Zed", "Akali"]),
            _session("2026-05-04", "night",     4, 0.42, 2, 0, 0, 0, ["trash", "uninstall"], 1.8, 5.5, ["Zed"]),
            _session("2026-05-06", "morning",   2, 0.90, 0, 2, 0, 0, [], 5.5, 8.0, ["Zed", "Talon"]),
            _session("2026-05-07", "night",     5, 0.38, 3, 0, 0, 0, ["bot lobby", "report supp", "im carrying"], 1.5, 5.0, ["Zed"]),
            _session("2026-05-09", "afternoon", 3, 0.85, 0, 1, 0, 0, [], 5.0, 7.6, ["Zed", "Akali"]),
            _session("2026-05-10", "night",     6, 0.35, 4, 0, 0, 0, ["dog team", "diff", "ff", "report"], 1.4, 4.8, ["Zed"]),
            _session("2026-05-12", "afternoon", 2, 0.87, 0, 2, 0, 0, [], 5.3, 7.9, ["Zed", "Katarina"]),
            _session("2026-05-13", "night",     4, 0.40, 2, 0, 0, 0, ["trash", "gg go next"], 1.6, 5.2, ["Zed"]),
            _session("2026-05-15", "morning",   3, 0.89, 0, 3, 0, 0, [], 5.6, 8.1, ["Zed", "Akali"]),
            _session("2026-05-16", "night",     5, 0.33, 3, 0, 0, 0, ["report team", "braindead", "ff"], 1.3, 4.6, ["Zed"]),
        ],
        "trajectory": {
            "direction": "stable",
            "velocity": 0.0,
    ...
    "comeback-kid": {
        ...
        "sessions": [
            _session("2026-04-28", "evening", 3, 0.80, 0, 1, 0, 0, [], 3.2, 6.8, ["Lulu", "Soraka"]),
            _session("2026-04-30", "evening", 4, 0.65, 1, 0, 0, 0, ["diff"], 2.1, 6.2, ["Lulu"]),
            _session("2026-05-02", "night",   5, 0.45, 2, 0, 0, 0, ["trash", "ff"], 1.6, 5.5, ["Lulu"]),
            _session("2026-05-04", "night",   6, 0.30, 4, 0, 0, 0, ["report", "dog team", "im done", "afk"], 1.2, 5.0, ["Lulu"]),
            ...
            _session("2026-05-08", "afternoon", 2, 0.60, 0, 1, 0, 0, [], 2.8, 6.5, ["Lulu", "Soraka"]),
            _session("2026-05-10", "evening",   3, 0.72, 0, 2, 0, 0, [], 3.0, 6.7, ["Lulu", "Soraka"]),
            _session("2026-05-12", "evening",   3, 0.80, 0, 2, 0, 0, [], 3.3, 7.0, ["Lulu", "Soraka", "Nami"]),
            _session("2026-05-14", "evening",   2, 0.85, 0, 3, 0, 0, [], 3.5, 7.2, ["Lulu", "Soraka"]),
            _session("2026-05-16", "evening",   3, 0.88, 0, 3, 0, 0, [], 3.8, 7.5, ["Lulu", "Soraka", "Nami"]),
        ],
        "trajectory": {
            "direction": "recovering",
            "velocity": -0.04,
    ...
    "cascade-spiral": {
        ...
        "rank": {"tier": "EMERALD", "rank": "I", "leaguePoints": 120, "wins": 200, "losses": 190},
        "account_age_days": 400,
        "sessions": [
            _session("2026-05-14", "evening",   2, 0.92, 0, 3, 0, 0, [], 5.8, 8.5, ["Yasuo", "Yone"]),
            _session("2026-05-15", "evening",   3, 0.90, 0, 2, 0, 0, [], 5.5, 8.2, ["Yasuo", "Yone"]),
            # Trigger: teammate AFKs in ranked, causes loss
            _session("2026-05-16", "evening",   4, 0.55, 2, 0, 0, 0, ["afk top", "report supp", "4v5 every game"], 2.8, 6.5, ["Yasuo"]),
            _session("2026-05-16", "night",     5, 0.30, 4, 0, 1, 3, ["dog players", "hardstuck", "diff", "report", "im inting"], 1.8, 5.8, ["Yasuo"]),
            _session("2026-05-17", "morning",   3, 0.22, 3, 0, 2, 2, ["trolling", "ff", "im done with this game"], 1.4, 5.2, ["Yasuo"]),
            _session("2026-05-17", "evening",   6, 0.15, 5, 0, 3, 4, ["report all", "kys", "uninstall", "worst team", "throwing"], 1.0, 4.5, ["Yasuo"]),
            _session("2026-05-18", "afternoon", 4, 0.12, 4, 0, 3, 3, ["gg open", "ff", "report", "dog lobby"], 0.9, 4.2, ["Yasuo"]),
            _session("2026-05-18", "night",     5, 0.08, 5, 0, 4, 4, ["kill yourselves", "worst game", "inting every game", "report"], 0.7, 3.8, ["Yasuo"]),
            _session("2026-05-19", "morning",   3, 0.10, 3, 0, 3, 3, ["im done", "ff", "report team"], 0.8, 4.0, ["Yasuo"]),
            _session("2026-05-19", "evening",   4, 0.05, 4, 0, 4, 4, ["worst players", "im intentionally feeding", "report all"], 0.5, 3.5, ["Yasuo"]),
        ],
        "trajectory": {
            "direction": "spiraling",
            "velocity": 0.12,
